...
SOURCES += src/app.c src/atoms/function/cc_func.c src/atoms/function/delve.c src/atoms/function/drum.c src/atoms/function/mode_func.c src/atoms/function/note_func.c src/atoms/function/pc_func.c src/atoms/function/phrase.c
...
SOURCES += src/molecules/music/diatonic.c src/molecules/music/arp.c src/molecules/time/animation.c src/molecules/time/arpegiator.c src/molecules/time/loop.c src/molecules/time/sequence.c src/molecules/event.c src/molecules/external_input.c src/molecules/pad.c
